...
@section('content')
	...
	<!-- Nav tabs -->
		<div >
			...
			<li role="presentation" ><a href="#poslate" aria-controls="poslate" role="tab" data-toggle="tab"><img id="img_poslate" src="/img/email-send-icon.png"></a></li>
			<li role="presentation" class="active"><a href="#primljene" aria-controls="primljene" role="tab" data-toggle="tab"><img id="img_primljene" src="/img/email-receive-icon.png"></a></li>
			</ul>
		    			...
		    			id: id
							...
							$('#mail').html('' +
								'<div style="height:620px; border-bottom:none; box-shadow:0 -20px 15px -15px #888, 15px 0px 15px -15px #888, -15px 0px 15px -20px #888; border-radius:10px;"  class="col-sm-8">'+
									'<div style="margin-top:20px;">'+
										'<a type="button" href=""  data-id='+data[0].posiljalac_id+'  data-tooltip="true" data-toggle="modal" data-target="#myModal" title="Pošalji poruku" ><img style="height:102px;" src="/img/replay-icon.png"/></a> &nbsp'+
										'<a type="button" href="" onclick="obrisiPoruku('+data[0].id+')" data-tooltip="true" title="Obriši poruku"><img style="height:102px;" src="/img/delete-icon.png"/></a>'+
		...
		$.post('/administracija/poruke/primljene',
		    		{
		    			...
		    			id: id
							...
							$('#mail').html('' +
								'<div style=" height:620px; box-shadow: 0 -20px 15px -15px #888, 15px 0px 15px -15px #888, -15px 0px 15px -20px #888; border-radius:10px;"  class="col-sm-8">'+
									'<div style="margin-top:20px;">'+
										'<a type="button" href="" data-id='+data[0].posiljalac_id+' data-toggle="modal" data-target="#myModal"><img style="height:102px;" src="/img/replay-icon.png"/></i></a> &nbsp'+
										'<a type="button" href="" onclick="obrisiPoruku('+data[0].id+')" data-tooltip="true" title="Obriši poruku"><img style="height:102px;" src="/img/delete-icon.png"/></a>'+
											'<a  href=""><span style="margin-top:5px;" class="pull-right glyphicon glyphicon-option-vertical"></span></a>'+
									'<div>'+
									'<br>'+
	  ...
	  <div class="modal-dialog" role="document">
	    <div style="width:100%; border-top:5px solid #269ABC; opacity: 0.85; background: url(/img/bg2.jpg) no-repeat center center fixed;" class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        {!! Form::button('<span class="glyphicon glyphicon-ok"></span>&nbsp Pošalji',['class'=>'btn3d btn btn-sm btn-success','onclick'=>'Komunikacija.posalji("/administracija/poruke/posaljimail",\'forma\',\'poruka\',\'vrti\',\'forma\')' ]) !!}
	      </div>
	    </div>
	  </div>
	</div>
